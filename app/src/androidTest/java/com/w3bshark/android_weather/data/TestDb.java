 ...
 */
package com.w3bshark.android_weather.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // Simply only checking that values were inserted into db table here
        Cursor c = db.query(WeatherContract.LocationEntry.TABLE_NAME,
                null, null, null, null, null, null);

        // Move the cursor to a valid database row
        assertTrue("Error: Could not find any location entries", c.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: data does not match original values",
                c, values);
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: Could not find any weather entries", c.moveToFirst());
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        // And return the location ID that was inserted
